...
internal sealed class GetAllScheduleQueryHandler : IRequestHandler<GetAllScheduleQuery, ErrorOr<IReadOnlyList<ScheduleResponse>>>
{
    ...
    public async Task<ErrorOr<IReadOnlyList<ScheduleResponse>>> Handle(GetAllScheduleQuery query, CancellationToken cancellationToken)
    {
