...
namespace Infrastructure.Persistence.Repositories
{
    public class CourseRepository : ICourseRepository
    {
        ...
        public async Task<bool> ExistsAsync(CourseId id) => await _context.Courses.AnyAsync(course => course.CourseId == id);
        public async Task<Course?> GetByIdAsync(CourseId courseId) => await _context.Courses.SingleOrDefaultAsync(c => c.CourseId == courseId);
