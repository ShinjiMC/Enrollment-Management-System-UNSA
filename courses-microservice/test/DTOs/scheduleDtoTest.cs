...
namespace course_microservice.test.DTOs
{
    ...
    {
        [Test]
        public void ScheduleDto_SetAndGetProperties_ShouldReturnCorrectValues()
        {
            // Arrange
            ...
            var course = new CourseDto { ID = 101, Name = "Math", Semester = 'S', Credits = 3, Year = 2024, Hours = 60 };
            var weekDay = new WeekDayDto { ID = 5, Name = "Friday" };
            var school = new SchoolDto { ID = 20, Name = "Engineering", Faculty = "Science", Area = "Technology", FoundationDate = new DateTime(1990, 1, 1, 11, 0, 0, DateTimeKind.Utc) };
        ...
        [Test]
        public void ScheduleDto_DefaultValues_ShouldReturnDefaultValues()
        {
            // Arrange & Act
            var scheduleDto = new ScheduleDto();
